...
<style>
    #<?= $id ?> { margin:0 auto; }
    #<?= $id ?> .ad-inner { position:relative; display:flex; flex-direction:column; align-items:center; justify-content:center; border-radius:var(--radius-md); background:var(--card); border:1px solid var(--border); overflow:hidden; transition:border-color .2s; }
    #<?= $id ?> .ad-inner:hover { border-color:var(--border-strong); }
    #<?= $id ?> .ad-label { position:absolute; top:6px; left:10px; font-size:.55rem; text-transform:uppercase; letter-spacing:.1em; color:var(--text-muted); opacity:.4; font-weight:600; }
...
<style>
    ...
    #<?= $id ?>-wrap .ad-inner { position:relative; display:flex; flex-direction:column; align-items:center; justify-content:center; border-radius:var(--radius-md); background:var(--card); border:1px solid var(--border); overflow:hidden; min-height:50px; }
    #<?= $id ?>-wrap .ad-label { position:absolute; top:4px; left:8px; font-size:.5rem; text-transform:uppercase; letter-spacing:.1em; color:var(--text-muted); opacity:.35; font-weight:600; z-index:1; }
